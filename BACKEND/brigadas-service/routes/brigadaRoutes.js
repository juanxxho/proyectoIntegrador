...
router.post('/', verifyToken, verifyRole(['administrador']), brigadaController.createBrigada);
...
router.put('/:id/estado', verifyToken, verifyRole(['administrador', 'jefe_brigada']), brigadaController.updateBrigadaEstado);

// Obtener expertos por rol — cualquier usuario autenticado
router.get('/expertos/:rol', verifyToken, expertoController.obtenerExpertosPorRol);
