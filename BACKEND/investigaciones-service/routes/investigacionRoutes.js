...
router.post(
  ...
  investigacionController.crearInvestigacion
);
...
router.get(
  "/brigada/:id_brigada",
  verifyToken,
  investigacionController.obtenerPorBrigada
);
...
router.put(
  ...
  verifyToken,
  verifyRole(["administrador"]),
  investigacionController.cambiarEstado
);
router.put(
  "/:id/asignar-brigada",
  verifyToken,
  verifyRole(["administrador"]),
  investigacionController.asignarBrigada
);
