...
interface User {
  id: string
  email: string
  role: "administrador" | "jefe_brigada" | "botanico" | "auxiliar" | "coinvestigador"
  ...
  const login = async (email: string, password: string) => {
    try {
      ...
      toast({
        ...
        description: error.response?.data?.message || "Credenciales incorrectas. Por favor, inténtalo de nuevo.",
      })
      throw error
    } finally {
      setLoading(false)
  ...
  const register = async (email: string, password: string, role: string) => {
    try {
      ...
      toast({
        ...
        description: response.data.message || "Tu cuenta ha sido creada. Ahora puedes iniciar sesión.",
      })
      ...
      toast({
        ...
        description: error.response?.data?.message || "No se pudo crear la cuenta. Por favor, inténtalo de nuevo.",
      })
      throw error
    } finally {
      setLoading(false)
