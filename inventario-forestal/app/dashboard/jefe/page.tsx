      ...
      <div className="flex flex-col gap-6">
        ...
        <Card className="border-green-200 dark:border-green-800">
          <CardHeader>
            ...
            <CardDescription>
              Detalles de la investigación asignada a tu brigada
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold">
                  Evaluación de Biodiversidad en Bosque Tropical
                </h3>
                <p className="text-sm text-muted-foreground">
                  ID: INV-2023-042 • Inicio: 12/04/2023
                </p>
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Estado de las tareas asignadas a los miembros de tu brigada
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Personal asignado a tu brigada para la investigación actual
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
